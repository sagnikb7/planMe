  ...
  return (
    <div className="auth-root">
      <div className="auth-card">
        ...
        <h1 className="mb-0.5 text-xl font-semibold text-[var(--ds-color-text)]">Create account</h1>
        <p className="mb-5 text-sm text-[var(--ds-color-text-muted)]">Free, private, no fluff.</p>
